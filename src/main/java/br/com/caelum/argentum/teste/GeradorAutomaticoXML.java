...
public class GeradorAutomaticoXML {
	public static void main(String[] args) throws FileNotFoundException {
		...
		for (int dias = 0; dias < 30; dias++) {
			...
			for (int negociacao = 0; negociacao < quantidadeNegociacoesDia; negociacao++) {
				// maximo sobe ou cai R$1,00 e não baixa além de R$5,00
